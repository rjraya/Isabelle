...
section \<open>Big-step semantic definition for the GCL language.\<close>

subsection \<open>Big-step semantic definition\<close>
...
text \<open> In contrast with IMP, GLC is non-deterministic. \<close>
...
text \<open>
 ...
 This means that not every program configuration leas to a final state.
\<close>
...
subsection \<open>Definition of command equivalence and proof of equivalence relation\<close>
...
text \<open>
 ...
 The proofs are analogous to the one in IMP.
\<close>
lemma equivI[intro?]: 
...
subsection \<open>Congruence results\<close>
...
subsection \<open>Basic results used in subsequent theories\<close>
